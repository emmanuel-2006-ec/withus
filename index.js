...
app.post('/api/chat', async (req, res) => {
    ...
    if (message.startsWith('.task ')) {
        ...
        if (HF_API_KEY === 'YOUR_HF_API_KEY_HERE' || HF_API_KEY === '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') {
            // Actually we have a key, so let's use it
            // The condition above is just for safety
        }
...
app.listen(PORT, () => {
    ...
    console.log(`🔍 Facebook Search: ✅ Active`);
});
